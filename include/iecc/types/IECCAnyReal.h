...
*******************************************************************************/
//
#ifndef __IECC_INCLUDE_IECC_TYPES_ANY_REAL_INCLUDE__
  #define __IECC_INCLUDE_IECC_TYPES_ANY_REAL_INCLUDE__
  #include "types/IECCAnyNum.h"
#endif

//
#ifndef __IECC_INCLUDE_IECC_TYPES_ANY_REAL_DEFINE__
  #ifdef __IECC_INCLUDE_IECC_TYPES_ANY_NUM_DEFINE__
    #define __IECC_INCLUDE_IECC_TYPES_ANY_REAL_DEFINE__
    
    //
    @interface IECCAnyReal: IECCAnyNum
