...
*******************************************************************************/
//
#ifndef __IECC_INCLUDE_IECC_TYPES_USINT_INCLUDE__
  #define __IECC_INCLUDE_IECC_TYPES_USINT_INCLUDE__
  #include "types/IECCAnyUnsigned.h"
#endif

//
#ifndef __IECC_INCLUDE_IECC_TYPES_USINT_DEFINE__
  #ifdef __IECC_INCLUDE_IECC_TYPES_ANY_UNSIGNED_DEFINE__
    #define __IECC_INCLUDE_IECC_TYPES_USINT_DEFINE__
    
    //
    @interface IECCUSInt: IECCAnyUnsigned
