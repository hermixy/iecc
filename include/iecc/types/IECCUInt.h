...
*******************************************************************************/
//
#ifndef __IECC_INCLUDE_IECC_TYPES_UINT_INCLUDE__
  #define __IECC_INCLUDE_IECC_TYPES_UINT_INCLUDE__
  #include "types/IECCAnyUnsigned.h"
#endif

//
#ifndef __IECC_INCLUDE_IECC_TYPES_UINT_DEFINE__
  #ifdef __IECC_INCLUDE_IECC_TYPES_ANY_UNSIGNED_DEFINE__
    #define __IECC_INCLUDE_IECC_TYPES_UINT_DEFINE__
    
    //
    @interface IECCUInt: IECCAnyUnsigned
