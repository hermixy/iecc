...
*******************************************************************************/
//
#ifndef __IECC_INCLUDE_IECC_TYPES_ANY_BIT_INCLUDE__
  #define __IECC_INCLUDE_IECC_TYPES_ANY_BIT_INCLUDE__
  #include "types/IECCAnyElementary.h"
#endif

//
#ifndef __IECC_INCLUDE_IECC_TYPES_ANY_BIT_DEFINE__
  #ifdef __IECC_INCLUDE_IECC_TYPES_ANY_ELEMENTARY_DEFINE__
    #define __IECC_INCLUDE_IECC_TYPES_ANY_BIT_DEFINE__
    
    //
    @interface IECCAnyBit: IECCAnyElementary
