...
*******************************************************************************/
//
#ifndef __IECC_INCLUDE_IECC_TYPES_WCHAR_INCLUDE__
  #define __IECC_INCLUDE_IECC_TYPES_WCHAR_INCLUDE__
  #include "types/IECCAnyChar.h"
#endif

//
#ifndef __IECC_INCLUDE_IECC_TYPES_WCHAR_DEFINE__
  #ifdef __IECC_INCLUDE_IECC_TYPES_ANY_CHAR_DEFINE__
    #define __IECC_INCLUDE_IECC_TYPES_WCHAR_DEFINE__
    
    //
    @interface IECCWChar: IECCAnyChar
